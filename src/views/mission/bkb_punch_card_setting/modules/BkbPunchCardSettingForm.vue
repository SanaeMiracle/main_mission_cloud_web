        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="限制辖区" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="area">
              <a-radio-group v-model="model.area" name="radioGroup">
          ...
          <a-col :span="24">
            <a-form-model-item
              ...
              :labelCol="labelCol"
              :wrapperCol="wrapperCol"
              prop="isClickReviewStatus"
            >
              <a-radio-group v-model="model.isClickReviewStatus" name="radioGroup">
                <a-radio value="YES">是</a-radio>
                <a-radio value="NO">否</a-radio>
              </a-radio-group>
            </a-form-model-item>
          </a-col>
          <a-col :span="24" v-if="model.isClickReviewStatus == 'YES'">
            <a-form-model-item
              label="审核类型"
              :labelCol="labelCol"
              :wrapperCol="wrapperCol"
            ...
            >
              <a-radio-group v-model="model.oneClickReviewStatus" name="radioGroup">
                <a-radio value="AUTOMATED_MODERATION">自动审核</a-radio>
                <a-radio value="MANUAL_REVIEW">手动审核</a-radio>
              </a-radio-group>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item
              ...
              :labelCol="labelCol"
              :wrapperCol="wrapperCol"
              prop="isSynchronousCircle"
            >
              <a-radio-group v-model="model.isSynchronousCircle" name="radioGroup">
                <a-radio value="YES">是</a-radio>
                <a-radio value="NO">否</a-radio>
              </a-radio-group>
            </a-form-model-item>
  ...
  data() {
    return {
      ...
      validatorRules: {
        ...
        area: [{ required: true, message: '请选择是否限制辖区!' }],
        isClickReviewStatus: [{ required: true, message: '请选择是否审核!' }],
        oneClickReviewStatus: [{ required: true, message: '请选择是审核类型!' }],
        isSynchronousCircle: [{ required: true, message: '请选择是否同步到圈子!' }]
      },
      url: {

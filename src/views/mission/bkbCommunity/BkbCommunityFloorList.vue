          ...
          <a-row>
            <a-col :span='8'>
              <a-form-model-item label='楼栋开始编号' :labelCol='labelCol' :wrapperCol='wrapperCol' prop='floorStart'>
                <a-input-number :min='0' :max='999' v-model='model.floorStart' placeholder='请输入楼栋开始编号' suffix='栋'
                                style='width: 100%' />
              </a-form-model-item>
            </a-col>
            <a-col :span='8'>
              <a-form-model-item label='楼栋结束编号' :labelCol='labelCol' :wrapperCol='wrapperCol' prop='floorEnd'>
                <a-input-number :min='0' :max='999' v-model='model.floorEnd' placeholder='请输入楼栋结束编号' suffix='栋'
                                style='width: 100%' />
              </a-form-model-item>
            </a-col>
            <a-col :span='8'>
              <a-form-model-item label='楼栋户数' :labelCol='labelCol' :wrapperCol='wrapperCol' prop='floorTenement'>
                <a-input-number :min='0' :max='999' v-model='model.floorTenement' placeholder='请输入楼栋户数' suffix='户'
                                style='width: 100%' />
              </a-form-model-item>
            </a-col>
            <a-col :span='8'>
              <a-form-model-item label='单元开始编号' :labelCol='labelCol' :wrapperCol='wrapperCol' prop='unitStart'>
                <a-input-number :min='0' :max='999' v-model='model.unitStart' placeholder='请输入单元开始编号' suffix='单元'
                                style='width: 100%' />
              </a-form-model-item>
            </a-col>
            <a-col :span='8'>
              <a-form-model-item label='单元结束编号' :labelCol='labelCol' :wrapperCol='wrapperCol' prop='unitEnd'>
                <a-input-number :min='0' :max='999' v-model='model.unitEnd' placeholder='请输入单元结束编号' suffix='单元'
                                style='width: 100%' />
              </a-form-model-item>
            </a-col>
            <a-col :span='8'>
              <a-form-model-item label='单元户数' :labelCol='labelCol' :wrapperCol='wrapperCol' prop='unitTenement'>
                <a-input-number :min='0' :max='999' v-model='model.unitTenement' placeholder='请输入单元户数' suffix='户'
                                style='width: 100%' />
              </a-form-model-item>
            </a-col>
          </a-row>

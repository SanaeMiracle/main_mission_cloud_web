        ...
        <a-row>
          ...
          <a-col :span='24'>
            <a-form-model-item label='楼栋住户数' :labelCol='labelCol' :wrapperCol='wrapperCol' prop='tenement'>
              <a-input-number :min='0' :max='999' v-model='model.tenement' placeholder='请输入楼栋住户数' style='width: 100%' />
            </a-form-model-item>
          </a-col>
          <a-col :span='24'>
        ...
        columns: [
          {
            ...
            defaultValue: '',
            validateRules: [{ required: true, message: '${title}不能为空或者3位数字', pattern: /^\d{0,3}$/ }]
          },
          {
            title: '单元住户数',
            key: 'tenement',

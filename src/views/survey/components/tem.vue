  ...
  <div class="mod-menu-home app-container" v-if="refresh">
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="地区：">
        <div class="areaBox">
          ...
          <el-radio-group v-model="ruleForm.isArea" style="margin-left: 40px" @change="change1">
        ...
        <ol>
          <li v-for="(item, index) in questionList" :key="item.id">
            <dl v-if="item.type == 'radio'">
              ...
              <el-radio disabled v-model="radio" :label="index" v-for="(item, index) in item.questionItem" :key="index">
                {{ item.content }}
              </el-radio>
            </dl>
            <!-- <br /> -->
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <!-- <el-button @click="submitContentForm">取 消</el-button> -->
      ...
      this.$refs.ruleForm.validate((valid) => {
        if (valid) {
          ...
          if (this.temId) {
            ...
            httpAction(
              `/mission/bkbQuestionnaireInquiryTemplate/edit?questionnaireVo=${JSON.stringify(this.questionList)}`,
            ...
            httpAction(
              `/mission/bkbQuestionnaireInquiryTemplate/add?questionnaireVo=${JSON.stringify(this.questionList)}`,
              bkbQuestionnaireInquiry,
              'post'
            ).then((res) => {
              console.log(res)
